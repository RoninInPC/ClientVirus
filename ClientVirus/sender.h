...
public:
    Sender(boost::asio::io_context& io_context, const char* destination)
...
private:
    void StartSend(const std::string& message)
    {
        ...
        timer_.async_wait(std::bind(&Sender::Timeout, this));
    }
    ...
    void StartReceive()    {
        ...
        socket_.async_receive(reply_buffer_.prepare(65536),
            std::bind(&Sender::HandleReceive, this, std::placeholders::_2));
    }
